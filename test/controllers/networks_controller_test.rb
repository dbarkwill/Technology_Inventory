...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { description: @network.description, name: @network.name, network: @network.network, vlan: @network.vlan }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { description: @network.description, name: @network.name, network: @network.network, vlan: @network.vlan }
    assert_redirected_to network_path(assigns(:network))
  end
