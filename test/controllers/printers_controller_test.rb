...
class PrintersControllerTest < ActionController::TestCase
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post :create, printer: { MAC: @printer.MAC, location: @printer.location, model: @printer.model, name: @printer.name, namufacturer: @printer.namufacturer, print_queue: @printer.print_queue }
    end
  ...
  test "should update printer" do
    patch :update, id: @printer, printer: { MAC: @printer.MAC, location: @printer.location, model: @printer.model, name: @printer.name, namufacturer: @printer.namufacturer, print_queue: @printer.print_queue }
    assert_redirected_to printer_path(assigns(:printer))
  end
